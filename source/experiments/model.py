...
class Model:
    ...
    def predict_predicate(self, w1, w2, k=10):
        ...
        distribution = dy.softmax(self.__predict_predicate__(W_p1, W_p2, w1_vec, w2_vec)).npvalue()
    ...
    def __predict_predicate__(self, W_p1, W_p2, w1_vec, w2_vec):
        """
        Predict the word w2 given w1 and the predicate
    ...
    def __compute_batch_loss__(self, W1, W2, W_p1, W_p2, batch_instances):
        ...
        for w1, predicate, w2, count in batch_instances:
            ...
            pred_p = self.__predict_predicate__(W_p1, W_p2, w1_vec, w2_vec)
