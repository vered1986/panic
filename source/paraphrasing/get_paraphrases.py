...
def main():
    ...
    wk_model = Model.load_model(args.language_model_dir, wv)
    ...
    for (w1, w2) in tqdm.tqdm(noun_compounds):
        ...
        pred_vectors = wk_model.predict_predicate(w2_index, w1_index, k=int(args.k))
        ...
        curr_paraphrases.extend([('{} {} {}'.format(w2, paraphrase, w1), score)
