...
def main():
    ...
    wv, words = load_binary_embeddings(args.embeddings_file, normalize=True)
    ...
    # Create the model
    model = Model(wv, model_dir=args.model_dir, n_epochs=args.nepochs, update_embeddings=args.update,
